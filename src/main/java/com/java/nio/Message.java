...
public class Message {
    ...
    public void writePartialMessageToMessage(Message message, int endIndex){
        ...
        System.out.println("startIndexOfPartialMessage==" + startIndexOfPartialMessage + ",offset==" + this.offset + ",lengthOfPartialMessage==" + lengthOfPartialMessage);
    ...
    public void releaseMessageBuffer() {
    	System.out.println("========================release message buffer " + this.offset);
    	messageBuffer.freeMessageBlock(this);
    }
}
